...
public sealed class FahrzeugDetailViewModel
{
    public Guid FahrzeugId { get; init; }

    public string Titel { get; init; } = "Fahrzeugdetails";

    public string Beschreibung { get; init; } =
        "Zentrale Übersicht zum Fahrzeug.";
    ...
    public IReadOnlyList<FahrzeugDokumentItemViewModel> Dokumente { get; init; } = [];
    public IReadOnlyList<FahrzeugPruefstatusItemViewModel> Pruefungen { get; init; } = [];
}