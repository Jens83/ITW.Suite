...
public sealed class TrackingGeraetStandortAktuell
{
    private TrackingGeraetStandortAktuell()
    {
        DeviceIdentifier = string.Empty;
    }

    public TrackingGeraetStandortAktuell(
        ...
        DateTimeOffset aktualisiertAmUtc)
    {
    ...
    public DateTimeOffset AktualisiertAmUtc { get; private set; }
